...
module.exports = {
  entry: {
    popup: path.join(__dirname, `../${SRC_DIR_NAME}/popup.js`),
    content: path.join(__dirname, `../${SRC_DIR_NAME}/content.js`),
    background: path.join(__dirname, `../${SRC_DIR_NAME}/background/${browser}/background.js`),
  },
  output: {
